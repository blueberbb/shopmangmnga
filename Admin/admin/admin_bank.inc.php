            ...
            <div class="page-content-wrapper">
                ...
                <main id="js-page-content" role="main" class="page-content">
                    ...
                    <span class="text-center">
                        <i class="fal fa-landmark text-center btn btn-primary " style=" font-size: 15px;" data-toggle="modal" data-target="#default-example-modal-lg"> + บัญชีธนาคาร </i>
                        <!-- Modal center -->
                    </span>

                    <!-- datatable start -->
                    <?php include('admin_table_bank.inc.php'); ?>



                    <!-- Modal Large add-->
                    <?php include('admin_add_bank.inc.php'); ?>
                ...
                <script>
                    ...
                    $('.btn-del').click(function(e) {
                        ...
                        Swal.fire({
                            title: 'คุณต้องการลบ ธนาคาร นี้หรือไม่?',
