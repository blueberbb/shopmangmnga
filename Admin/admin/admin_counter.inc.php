...
$query = "SELECT
COUNT(c_id) AS total, DATE_FORMAT(c_datesave, '%d-%m-%Y') AS datesave
FROM tbl_counter
        ...
        <div class="page-inner">
            ...
            <div class="page-content-wrapper">
                ...
                <main id="js-page-content" role="main" class="page-content">
                    <h2 align="center"><i class="fal fa-users-class"></i> รายงานยอดผู้เข้าชมเว็บไซต์</h2>
                    <p>
