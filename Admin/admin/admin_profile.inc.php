...
$sql = "SELECT m_username, m_img FROM tbl_member WHERE m_id=$m_id";
                            ...
                            <div class="col-12 ">
                                ...
                                <form action="" id="js-login" method="post" class="form-horizontal" enctype="multipart/form-data">
                                    <div class="text-center m-md-2">
                                        <i class="far fa-id-card" style="font-size: 30px;"> โปรไฟล์</i>
                                    </div>
                                    <div class="d-flex flex-column align-items-center justify-content-center p-4">
                                        <img src="../profile/<?php echo $_SESSION['m_img']; ?>" class="img-profile rounded-circle shadow-2 img-thumbnail">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 p-1">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" id="m_username" name="m_username" value="<?php echo $_SESSION['m_username']; ?>" readonly>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6 p-1">
                                                ...
                                                <select name="m_level" id="m_level" class="form-control" disabled>
                                                    <option value="<?php echo $_SESSION['m_level']; ?>"><?php echo $_SESSION['m_level']; ?></option>
                                            ...
                                            <div class="col-md-6 p-1">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" id="m_name" name="m_name" required value="<?php echo $_SESSION['m_name']; ?>" disabled>
                                            ...
                                            <div class="col-md-6 p-1">
                                                ...
                                                <div class="input-group">
                                                    <div class="input-group-text"><i class="fal fa-user"></i></div>
                                                    <input type="text" class="form-control" id="m_lname" name="m_lname" required value="<?php echo $_SESSION['m_lname']; ?>" disabled>
                                            ...
                                            <div class="col-md-6 p-1">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="email" class="form-control" id="m_email" name="m_email" required value="<?php echo $_SESSION['m_email']; ?>" disabled>
                                            ...
                                            <div class="col-md-6 p-1">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" id="m_phone" name="m_phone" required value="<?php echo $_SESSION['m_phone']; ?>" disabled>
                                            ...
                                            <div class="form-group col-12 p-1">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <textarea class="col-12 form-control" name="m_address" id="m_address" cols="30" rows="3" required placeholder="ที่อยู่" disabled><?php echo $_SESSION['m_address']; ?></textarea>
