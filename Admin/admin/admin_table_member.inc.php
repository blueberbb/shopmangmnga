...
if ($_GET['do'] == 'success') {
    ...
    Swal.fire({icon: "success",title: "บันทึกข้อมูลเรียบร้อยแล้ว",showConfirmButton: false,timer: 3000})
    </script>';
    echo '<meta http-equiv="refresh" content="2;url=admin_member.inc.php">';
}

if ($_GET['do'] == 'check') {
    echo '<script tpye="text/javascript">
    Swal.fire({icon: "error",title: "มี User ซ้ำกรุณากรอกใหม่อีกครั้ง!!!",showConfirmButton: false,timer: 3000})
    </script>';
    echo '<meta http-equiv="refresh" content="2;url=admin_member.inc.php">';
}
...
if ($_GET['do'] == 'delete') {
    echo '<script tpye="text/javascript">
    Swal.fire({icon: "success",title: "ลบข้อมูลเรียบร้อยแล้ว",showConfirmButton: false,timer: 3000})
    </script>';
    echo '<meta http-equiv="refresh" content="2;url=admin_member.inc.php">';
}
            ...
            ?>
             <tr>
                 ...
                 <td class="text-center">
                     ...
                     <a href="admin_delete_member_db.inc.php?m_id=<?php echo $row['m_id']; ?>" class="btn-del">
