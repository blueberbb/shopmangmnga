        ...
        <div class="page-inner">
            ...
            <div class="page-content-wrapper">
                ...
                <main id="js-page-content" role="main" class="page-content">
                    <div class="col-12">
                        <h3 class="font-weight-bold text-info"> รายละเอียดการแจ้งเลข EMS</h3>
                        <h4>
                        ...
                        <div class=" col-sm-6" style="float: right; ">
                                            <!-- <h3>แจ้งเลข EMS</h3> -->
                                            <div class="col-sm-6">
                    <h3 class="font-weight-bold">แจ้งเลข EMS <font color="#00ff99"><?PHP echo $rowdetail['o_ems']; ?></font>
                <br>
                ว/ด/ป <?PHP echo date('d/m/Y H:i:s',strtotime($rowdetail['o_ems_date'])); ?>
                น.
                </h3>
                 </div>
                        </div>
                        <div class=" col-sm-6" style="float: right; ">
                            ...
                            <a href="../img_slip/<?php echo $rowdetail['o_slip']; ?>" target="_blank">
                                <img src="../img_slip/<?php echo $rowdetail['o_slip']; ?>" width="20%">
                            </a>
                        </div>
