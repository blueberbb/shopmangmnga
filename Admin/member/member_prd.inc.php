        ...
        <div class="page-inner">
            ...
            <div class="page-content-wrapper">
                            ...
                            <div class="dropdown-menu dropdown-menu-animated dropdown-lg">
                                <div class="dropdown-header bg-trans-gradient d-flex flex-row py-4 rounded-top">
                                    <div class="d-flex flex-row align-items-center mt-1 mb-1 color-white">
                                        <span class="mr-2">
                                            <img src="../profile/<?php echo $_SESSION['m_img']; ?>" style="width: 50px;height: 50px;" class=" cursor-pointer rounded-circle profile-image" alt="Dr. Codex Lantern">
                ...
                <main id="js-page-content" role="main" class="page-content">
                    <i class="far fa-shopping-cart  text-center m-md-3" style="font-size: 25px;"> สินค้า</i>
                    <span class="text-center">
                        <i class="fal fa-cart-plus text-center btn btn-primary " style=" font-size: 15px;" data-toggle="modal" data-target="#default-example-modal-lg"> +เพิ่มสินค้า </i>
                        <!-- Modal center -->
                    </span>

                    <!-- datatable start -->
                    <?php include('admin_table_prd.inc.php'); ?>
                    <!-- Modal Large add-->
                    <?php include('admin_add_prd.inc.php'); ?>
                    <!-- Modal view -->
                ...
                <footer class="page-footer" role="contentinfo">
                    <div class="d-flex align-items-center flex-1 text-muted">
                        <span class="hidden-md-down fw-700">2021 © E-COMMERCE by&nbsp;<a href='#' class='text-primary fw-500' title='gotbootstrap.com' target='_blank'>KAIFARO</a></span>
                    </div>
                ...
                <script>
                    ...
                    function readURL4(input) {
                        if (input.files[0]) {
                            ...
                            $('.figure').addClass('d-block')
                            reader.onload = function(e) {
                                $('#imgUpload4').attr('src', e.target.result).height(200)
                            }
                            reader.readAsDataURL(input.files[0])
                        }
                    }
