...
<table id="dt-basic-example" class=" table table-bordered table-hover table-striped w-100">
    <thead class="bg-primary-600">
        <tr>
            ...
            <th class="text-center" width='8%'>วันเพิ่ม-แก้ไขสินค้า</th>
    ...
    <tbody>
        ...
        ?>
            <tr>
                ...
                <td class="text-center"><?php echo $row['p_qty']; ?></td>
                ...
                <td class="text-center">
                    ...
                    <a href="admin_delete_prd_db.inc.php?p_id=<?php echo $row['p_id']; ?>" onclick="return confirm('คุณต้องการลบสินค้านี้หรือไม่!!!');">
