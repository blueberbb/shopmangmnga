...
<head>
    ...
    <link rel="stylesheet" href="./assets1/vendor/bootstrap/bootstrap.min.css">
    <link rel="stylesheet" href="./assets1/vendor/bootstrap/offcanvas.css">
    <!-- CSS Global Icons -->
    <link rel="stylesheet" href="./assets1/vendor/icon-awesome/css/font-awesome.min.css">
    <link rel="stylesheet" href="./assets1/vendor/icon-line/css/simple-line-icons.css">
    <link rel="stylesheet" href="./assets1/vendor/icon-etlinefont/style.css">
    <link rel="stylesheet" href="./assets1/vendor/icon-line-pro/style.css">
    <link rel="stylesheet" href="./assets1/vendor/icon-hs/style.css">
    <link rel="stylesheet" href="./assets1/vendor/dzsparallaxer/dzsparallaxer.css">
    <link rel="stylesheet" href="./assets1/vendor/dzsparallaxer/dzsscroller/scroller.css">
    <link rel="stylesheet" href="./assets1/vendor/dzsparallaxer/advancedscroller/plugin.css">
    <link rel="stylesheet" href="./assets1/vendor/animate.css">
    <link rel="stylesheet" href="./assets1/vendor/hamburgers/hamburgers.min.css">
    <link rel="stylesheet" href="./assets1/vendor/malihu-scrollbar/jquery.mCustomScrollbar.min.css">
    <link rel="stylesheet" href="./assets1/vendor/slick-carousel/slick/slick.css">
    <link rel="stylesheet" href="./assets1/vendor/fancybox/jquery.fancybox.css">

    <!-- CSS Unify -->
    <link rel="stylesheet" href="./assets1/css/unify-core.css">
    <link rel="stylesheet" href="./assets1/css/unify-components.css">
    <link rel="stylesheet" href="./assets1/css/unify-globals.css">
...
<body>
                ...
                <div class="container">
                    <div class="d-lg-flex flex-md-row align-items-center g-pos-rel">
                        ...
                        <a href="./index.html" class="navbar-brand">
                            <img src="./assets1/img/logo/B3.png" alt="Image Description">
                        </a>
                        <!-- End Logo -->
                        ...
                        <div class="col g-mt-10 g-mt-0--lg g-px-0">
                            <ul class="list-inline text-uppercase g-font-weight-600 text-lg-right u-header--hidden-element g-line-height-1 g-font-size-12 g-mt-minus-10 g-mx-minus-4 g-mb-20">
                                ...
                                <li class="list-inline-item g-mx-4 g-mt-10">
                                    <a href="#" class="g-color-gray-dark-v2 g-color-primary--hover g-text-underline--none--hover">สมัครสมาชิก</a>
                                </li>
                                <li class="list-inline-item g-mx-4 g-mt-10">|</li>
                                <li class="list-inline-item g-mx-4 g-mt-10">
                                    <a href="#" class="g-color-gray-dark-v2 g-color-primary--hover g-text-underline--none--hover">เข้าสู่ระบบ</a>
                                </li>
                            </ul>
                                ...
                                <div class="collapse navbar-collapse align-items-center flex-sm-row g-pt-10 g-pt-5--lg g-mr-40--sm" id="navBar">
                                    <ul class="navbar-nav text-uppercase g-font-weight-600 ml-auto">
                                        <li class="nav-item g-mx-20--lg active">
                                            <a href="new.php" class="nav-link px-0">หน้าหลัก

                                            </a>
                                        </li>
                                        <li class="nav-item g-mx-20--lg">
                                            <a href="#" class="nav-link px-0">รายการสินค้า

                                            </a>
                                        </li>
                                        <li class="nav-item g-mx-20--lg ">
                                            <a href="#" class="nav-link px-0">ติดต่อเรา
                                                ...
                                                <div class="row align-items-center no-gutters">
                                                    <div class="col-4 g-pr-20">
                                                        <a href="#" class="u-basket__product-img">
                                                            <img src="./assets1/img-temp/150x150/img1.jpg" alt="Image Description">
                                                        </a>
                                                    </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <address class="g-bg-no-repeat g-font-size-12 mb-0" style="background-image: url(./assets1/img/maps/map2.png);">
                            <!-- Location -->
    ...
    <script src="./assets1/vendor/bootstrap/offcanvas.js"></script>

    <!-- JS Implementing Plugins -->
    <script src="./assets1/vendor/dzsparallaxer/dzsparallaxer.js"></script>
    <script src="./assets1/vendor/dzsparallaxer/dzsscroller/scroller.js"></script>
    <script src="./assets1/vendor/dzsparallaxer/advancedscroller/plugin.js"></script>
    <script src="./assets1/vendor/masonry/dist/masonry.pkgd.min.js"></script>
    <script src="./assets1/vendor/imagesloaded/imagesloaded.pkgd.min.js"></script>
    <script src="./assets1/vendor/malihu-scrollbar/jquery.mCustomScrollbar.concat.min.js"></script>
    <script src="./assets1/vendor/slick-carousel/slick/slick.js"></script>
    <script src="./assets1/vendor/fancybox/jquery.fancybox.min.js"></script>

    <!-- JS Unify -->
    <script src="./assets1/js/hs.core.js"></script>

    <script src="./assets1/js/components/hs.header.js"></script>
    <script src="./assets1/js/helpers/hs.hamburgers.js"></script>

    <script src="./assets1/js/components/hs.dropdown.js"></script>
    <script src="./assets1/js/components/hs.scrollbar.js"></script>
    <script src="./assets1/js/components/hs.popup.js"></script>
    <script src="./assets1/js/components/hs.carousel.js"></script>

    <script src="./assets1/js/components/hs.go-to.js"></script>
